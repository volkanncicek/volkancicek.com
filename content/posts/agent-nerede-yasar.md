...
Image: images/agent-nerede-yasar/hero.png
...
Aynı yazının açılış cümlesi ise bu blog yazısının da özrü sayılır: *"Harnesses encode assumptions that go stale as models improve."* Harness'ler, modeller iyileştikçe bayatlayan varsayımları kodlar. Windsurf'ün dört ay içinde ölmesi bir talihsizlik değil, bu cümlenin doğal sonucu.
