...
AI bu sistemlerde arkeolog gibi çalışabilir. Kodu okuyup ne yaptığını açıklaması, dokümantasyon üretmesi, stored procedure'lardaki iş mantığını gün yüzüne çıkarması — bunlarda gerçekten işe yarıyor. Eski sistemi unit testlerle sarmak, mevcut davranışı belgelemek, bağımlılık haritası çıkarmak — "bu modülü değiştirirsem ne etkilenir?" sorusunu sormak.
